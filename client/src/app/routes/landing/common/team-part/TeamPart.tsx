...
export const TeamPart = ({} : ITeamPartProps) => (
	<div className="call-to-action">
		...
		<Link to='/lk/auth/registration' className="landing-button landing-button--big">Почати</Link>
		<Link to='/lk/auth/login' className="call-to-action__link">Увійдіть, якщо вже є акаунт</Link>
	</div>
);